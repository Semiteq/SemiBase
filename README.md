...
# конфигурация сервера, архивная база, роли `scada_writer`, `semiplot` и
# `semiplot_registrar`, права, таблица архива, четыре таблицы SemiPlot и функция
# регистрации новых перьев
.\semibase.exe site
```
